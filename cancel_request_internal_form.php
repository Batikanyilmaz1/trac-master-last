	...
	<div id="div_form_page<?php echo $index; ?>" align="center">
		...
		<div align="right">
			<div style="display: flex; width: 195px;">
				...
				<div>
					<input type="button" id="btn_ok<?php echo $index; ?>" index="<?php echo $index; ?>" requestid="<?php echo $requestid; ?>" area="area6" action="warn" class="btn" value="Tamam ✔" onClick="cancel_request($(this));" />
				</div>
			</div>
		</div>
	</div>
