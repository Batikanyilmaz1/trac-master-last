...
?>
	<div id="div_form_page<?php echo $index; ?>" align="center">
		...
		<div align="left" style="height: 116px;">
			...
			<div><textarea id="txt_explanation<?php echo $index; ?>" name="txt_explanation" label="div_lbl<?php echo $index; ?>" area="area4" action="go" class="inp" style="height: 88px;" placeholder="Revize nedenini yazınız"></textarea></div>
		</div>
		<div align="right">
